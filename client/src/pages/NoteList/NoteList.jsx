...
export default function NoteList() {
  ...
  return (
    ...
    <Link className="backBtn" to={"/"}>
      ...
      {typeof(filterValue) == "object" ? console.log("VALUE: ", filterValue.target.value): null}
      {current_notes ? 
        current_notes.map((note, index) => (
          <NoteLink key={index} {...note} />
        )) : null}
      {current_notes.length == 0 && typeof(filterValue) == "string" || filterValue && filterValue.target.value.trim() == ""? 
